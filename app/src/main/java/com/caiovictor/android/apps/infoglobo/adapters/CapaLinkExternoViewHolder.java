...
public class CapaLinkExternoViewHolder extends RecyclerView.ViewHolder implements CapaViewHolderInterface, View.OnClickListener {
    ...
    public CapaLinkExternoViewHolder(@NonNull View itemView, OnCapaConteudoListener onCapaConteudoListener) {
        super(itemView);
